 ...
 */
public class FETreeManagerTest
{
    ...
    public void testSize(){
        ParetoSetManager list = FETreeManager.managerFactory(2);
    ...
    throws IllegalNumberOfObjectivesException {
        ...
        SharedTest.exampleRun(FETreeManager.managerFactory(objectiveNumber),new Random(0L),objectiveNumber,numberOfQueries);      
    }
    ...
    throws IllegalNumberOfObjectivesException {
        ...
        EvolutionStrategyTest.exampleRunDTLZ(FETreeManager.managerFactory(objectiveNumber), 
