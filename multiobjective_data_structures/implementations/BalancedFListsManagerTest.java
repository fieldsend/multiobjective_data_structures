 ...
 */
public class BalancedFListsManagerTest
{
     ...
     */
    public BalancedFListsManagerTest()
    {
    }
    ...
    public void testSize(){
        ParetoSetManager list = BalancedFListsManager.managerFactory(2);
    ...
    throws IllegalNumberOfObjectivesException {
        ...
        SharedTest.exampleRun(BalancedFListsManager.managerFactory(objectiveNumber),new Random(0L),objectiveNumber,numberOfQueries);      
    }
    ...
    throws IllegalNumberOfObjectivesException {
        ...
        EvolutionStrategyTest.exampleRunDTLZ(BalancedFListsManager.managerFactory(objectiveNumber), 
